...
class VoyagerAdminInstall extends Command
{
    ...
    {
        if ($this->confirm('Isso excluirá todos os dados atuais. Tem certeza?')) {
            $this->loadDefaults();
           $this->info('Dados fictícios foram instalados!');
       }
    }
    ...
    public function loadDefaults(){
        ...
        if ($copySuccess) {
            $this->info('Imagens copiadas com sucesso para a pasta de armazenamento');
        }
